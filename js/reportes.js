...
window.addEventListener("load", () => {
  ...
  gsap.from(".rep-header",      { y: 20,  opacity: 0, duration: 0.5, delay: 0.1, ease: "power3.out" });
  gsap.from(".rep-metric-card", { y: 16,  opacity: 0, duration: 0.4, stagger: 0.06, delay: 0.2, ease: "power2.out" });
  gsap.from(".rep-panel",       { y: 20,  opacity: 0, duration: 0.5, stagger: 0.08, delay: 0.3, ease: "power3.out" });
});
